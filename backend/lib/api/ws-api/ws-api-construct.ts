...
export class WSApiConstruct extends Construct {
    constructor(scope: Construct, id: string, props: {
        connectionTable: Table, messagesTable: Table, hostedZone: IHostedZone, certificate: ICertificate, siteDomain: string
    }) {
        super(scope, id)
        ...
        new route53.ARecord(this, 'Arecord', {
            target: RecordTarget.fromAlias(new targets.ApiGatewayv2DomainProperties(domainName.regionalDomainName, domainName.regionalHostedZoneId)),
